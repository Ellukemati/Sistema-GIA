...
pub struct ModeloInstrumento {
    ...
    pub imagen_principal_direccion: Option<String>,
}
...
impl ModeloInstrumento {
    ...
    pub fn from_row(row: &Row) -> SqlResult<Self> {
        Ok(ModeloInstrumento {
            ...
            imagen_principal_direccion: row.get("imagen_principal_direccion")?,
        })
    }

    pub fn cambiar_imagen_principal_direccion(&mut self, nueva_url: String) {
        self.imagen_principal_direccion = Some(nueva_url);
    }
